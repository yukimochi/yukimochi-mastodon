...
class MediaAttachment < ApplicationRecord
  ...
  IMAGE_FILE_EXTENSIONS = %w(.jpg .jpeg .heic .png .gif .webp).freeze
  ...
  IMAGE_MIME_TYPES               = %w(image/jpeg image/heic image/png image/gif image/webp).freeze
  IMAGE_NORMALIZATION_MIME_TYPES = %w(image/heic).freeze
